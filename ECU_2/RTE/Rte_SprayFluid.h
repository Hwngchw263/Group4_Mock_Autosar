...
extern FUNC(Std_ReturnType, RTE_CODE_EcucPartition_0) Rte_Read_SprayFluid_R_FluidMotor( P2VAR(boolean, AUTOMATIC, RTE_APPL_DATA) data );
#define Rte_Read_R_FluidMotor Rte_Read_SprayFluid_R_FluidMotor
